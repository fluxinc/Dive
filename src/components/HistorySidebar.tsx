...
import { DevModeOnlyComponent } from "./DevModeOnlyComponent"
        ...
        <div className="sidebar-footer">
          <DevModeOnlyComponent component={
            <button className="sidebar-footer-btn" onClick={handleDocumentStatus}>
              ...
              {t("sidebar.documentStatus", "Doc Status")}
            </button>
          } />
          <DevModeOnlyComponent component={
          ...
          <DevModeOnlyComponent component={
            <button className="sidebar-footer-btn" onClick={handleModels}>
          ...
          <button className="sidebar-footer-btn" onClick={handleUpload}>
